...
namespace Djinde.Quest
{
    public class SaveManager : MonoBehaviour
    {
        ...
        public List<int> DestroyedItemsIds { get; private set; } = new List<int>();
        public List<int> LitLightsIds { get; private set; } = new List<int>();
        public Dictionary<int, bool> DoorsStates { get; private set; } = new Dictionary<int, bool>();
        public List<int> UnlockedDoorsIds { get; private set; } = new List<int>();
        public List<int> OpenedChestsIds { get; private set; } = new List<int>();
        public List<int> KilledEnnemiesIds { get; private set; } = new List<int>();
        ...
        public List<ESpellType> LearntSpells { get; private set; } = new List<ESpellType>();
