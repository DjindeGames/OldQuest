...
namespace Djinde.Quest
{
    public class LoadScreenManager : MonoBehaviour
    {
        ...
        public void RefreshFilesList()
        {
            ...
            {
                Tools.LogWarning(this, "Save files directory not found, creating a new one now.");
        ...
        public void OnLoadRequest()
        {
            ...
            {
                Tools.LogError(this, "Requested load on a null file, this should not happen !");
            }
        }
        ...
        public void OnDeleteRequest()
        {
            ...
            {
                Tools.LogError(this, "Requested delete on a null file, this should not happen !");
            }
        }
