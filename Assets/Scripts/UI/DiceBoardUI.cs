        ...
        public void showActionResult(EThrowActionType actionType, int result)
        {
            ...
            switch (actionType)
            {
                ...
                case (EThrowActionType.EnnemyWound):
                    ...
                    {
                        textResult.text = "The ennemy has wounded you " + result + " times for a total of " + CombatManager.Instance.CurrentEnnemy._Stats.GetPassiveStatOfType(EPassiveStatType.Damages) * result + " points of damages.";
                    }
                    break;
            }
